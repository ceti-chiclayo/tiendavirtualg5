<div class="modal-header">
    <h4 class="modal-title">Actualizar medida</h4>
</div>
    ...
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-9 div-input">
                <input type="text" required value="<?= $medida->nombre ?>" name="nombre" id="nombre" class="form-control" />
            </div>
        </div>
    </div>
