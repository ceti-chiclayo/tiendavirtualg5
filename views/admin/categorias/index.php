<div class="content-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de categorías</h5>
                        </div>
                        <div class="card-body">
                            <form class="form-inline" id="formulario-buscar" autocomplete="off">
                                ...
                                <a target="__blank" id="boton-reporte-pdf" href="/categorias/reportepdf" class="btn btn-info ml-1 my-1">
                                    <i class="fas fa-file-pdf"></i> Reporte PDF
                                </a>
                                <a target="__blank" id="boton-reporte-excel" href="/categorias/reporteexcel" class="btn btn-secondary ml-1 my-1">
    ...
    <div id="modal-categoria" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
    ...
    function confirmarEliminar(id, boton) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const url = "/categorias/destroy/" + id;
                axios.post(url)
                    .then(function(response) {
