    ...
    <div class="modal-body">
        <div class="form-group row">
            ...
            <div class="col-sm-9 div-input">
                <input type="text" required value="<?= $categoria->nombre ?>" name="nombre" id="nombre" class="form-control" />
            </div>
        </div>
        <!-- <div class="form-group row">
