<div class="content-wrapper">
    ...
    <div id="modal-proveedor" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
...
<script>
    ...
    function modalEditar(id, boton) {
        boton.disabled = true;
        const ruta = "/proveedores/edit/" + id;
        axios.get(ruta)
            .then(function(response) {
                const codigo_html = response.data;
                $('#modal-contenido').html(codigo_html);
    ...
    function confirmarEliminar(id, boton) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const url = "/proveedores/destroy/" + id;
                axios.post(url)
                    .then(function(response) {
