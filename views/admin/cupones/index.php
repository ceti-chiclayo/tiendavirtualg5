<div class="content-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de cupones</h5>
                        </div>
                        <div class="card-body">
                            <form class="form-inline" id="formulario-buscar" autocomplete="off">
                                <label class="my-1 mr-2" for="texto_busqueda">Codigo</label>
                                <input type="text" class="form-control my-1 mr-sm-2" id="texto_busqueda"
                                       placeholder="Escriba un texto">
                                <button id="boton-buscar" onclick="buscar()" type="button"
                                        class="btn btn-primary my-1 mr-1">
                                    <i class="fas fa-search"></i> Buscar
                                </button>
                                <button id="boton-crear" onclick="modalCrear()" type="button"
    ...
    <div id="modal-cupon" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
