<div class="content-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de clientes</h5>
                        </div>
                        <div class="card-body">
    ...
    <div id="modal-cliente" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
