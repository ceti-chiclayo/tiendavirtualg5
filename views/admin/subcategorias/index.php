<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sub categorias de productos</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de sub categorías</h5>
                        </div>
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Listado de subcategorías</h3>
                        </div>
    ...
    <div id="modal-subcategoria" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
...
<script>
    ...
    function buscar() {
        ...
        axios.get('/subcategorias/search', {
                "params": {
    ...
    function modalCrear() {
        ...
        boton.disabled = true;
        axios.get('/subcategorias/create')
    ...
    function modalEditar(id, boton) {
        boton.disabled = true;
        const ruta = "/subcategorias/edit/" + id;
        axios.get(ruta)
            .then(function(response) {
                const codigo_html = response.data;
                $('#modal-contenido').html(codigo_html);
    ...
    function confirmarEliminar(id, boton) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const url = "/subcategorias/destroy/" + id;
                axios.post(url)
                    .then(function(response) {
