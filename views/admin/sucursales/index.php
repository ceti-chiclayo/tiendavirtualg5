<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Sucursal de productos</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de sucursales</h5>
                        </div>
                        <div class="card-body">
    ...
    <div id="modal-sucursal" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
    ...
    function confirmarEliminar(id, boton) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                const url = "/sucursales/destroy/" + id;
                axios.post(url)
                    .then(function(response) {
