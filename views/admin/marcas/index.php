<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Marca de productos</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de marcas</h5>
                        </div>
                        <div class="card-body">
    ...
    <div id="modal-marca" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
