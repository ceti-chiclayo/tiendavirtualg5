<div class="content-wrapper">
                ...
                <div class="col-lg-12">
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <h5 class="m-0">Búsqueda de compras</h5>
                        </div>
                        <div class="card-body">
                            <form class="form-inline" id="formulario-buscar" autocomplete="off">
                                <label class="my-1 mr-2" for="fecha_inicio">Fecha de inicio</label>
                                <input value="<?= date('Y-m-d') ?>" type="date" class="form-control my-1 mr-sm-2"
                                       id="fecha_inicio" name="fecha_inicio"
                                       placeholder="Escriba un texto">
                                <label class="my-1 mr-2" for="fecha_fin">Fecha de fin</label>
                                <input value="<?= date('Y-m-d') ?>" type="date" class="form-control my-1 mr-sm-2"
                                       id="fecha_fin" name="fecha_fin"
                                       placeholder="Escriba un texto">
                                <button id="boton-buscar" onclick="buscar()" type="button"
                                        class="btn btn-primary my-1 mr-1">
                                    <i class="fas fa-search"></i> Buscar
                                </button>
                                <a id="boton-crear" href="/compras/create" type="button"
    ...
    <div id="modal-compra" class="modal fade" tabindex="-1" data-backdrop='static' data-keyboard='false'>
...
<script>
    ...
    function buscar() {
        ...
        boton.disabled = true;
        quitarMensajesErrorValidation('formulario-buscar');
        axios.get('/compras/search', {
            "params": {
            ...
            if (error.response.status === 422) {
                mostrarErrores(error.response.data.errores, 'formulario-buscar');
            }
        }).finally(function () {
