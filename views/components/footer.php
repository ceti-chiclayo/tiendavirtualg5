                ...
                <div class="col-lg-5">
                    <div class="newsletter-area">
                        ...
                        <div class="newsletter-form_wrap">
                            <form action="https://devitems.us11.list-manage.com/subscribe/post?u=6bbb9b6f5827bd842d9640c82&amp;id=05d85f18ef"
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <div class="footer-widgets">
                                <ul>
                                    ...
                                    <?php else: ?>
                                        <li><a href="/login-registro">Iniciar sesión</a></li>
    ...
    <div class="footer-bottom_area">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="copyright">
                            <span>Copyright &copy; 2019 <a
                                        href="javascript:void(0)">Kenne.</a> All rights reserved.</span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="payment">
