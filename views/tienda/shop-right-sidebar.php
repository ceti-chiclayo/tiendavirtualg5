                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="single-product.html">Expedita
                                                excepturi</a></h3>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="single-product.html">Expedita
                                                excepturi</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="single-product.html">Rem voluptate</a>
                                        </h3>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="single-product.html">Rem voluptate</a>
                                        </h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h3 class="product-name"><a href="single-product.html">Aliquid vitae</a>
                                        </h3>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
