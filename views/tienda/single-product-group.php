...
<head>
    ...
    <title>Single Product Group || Kenne</title>
...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
        ...
        <!-- Begin Kenne's Single Product Group Area -->
        <div class="sp-area sp-group_area">
            <div class="container">
                <div class="sp-nav">
                    <div class="row">
                        <div class="col-lg-4">
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="pro-title">
                                                        <a href="single-product.html">Croen Summit Backpack</a>
                                                    </td>
        ...
        <!-- Kenne's Single Product Group Area End Here -->
