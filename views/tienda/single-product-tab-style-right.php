...
<head>
    ...
    <title>Single Product Tab Style Right || Kenne</title>
...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
        ...
        <!-- Begin Kenne's Tab Style Right Area -->
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="sp-img_area">
                                ...
                                <div class="sp-img_slider-nav slick-slider-nav kenne-element-carousel arrow-style-4" data-slick-options='{
                                    "slidesToShow": 3,
        ...
        <!-- Kenne's Tab Style Right Area End Here -->
