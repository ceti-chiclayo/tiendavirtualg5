...
<head>
    ...
    <title>Blog List View || Kenne</title>
...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
        ...
        <!-- Begin Kenne's Blog List View Area -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 order-lg-2 order-1">
                        <div class="row blog-item_wrap">
                            ...
                            <div class="col-12">
                                <div class="blog-item">
                                    <div class="kenne-element-carousel single-blog_slider arrow-style-2 overflow-hidden w-100" data-slick-options='{
                                        "slidesToShow": 1,
                                        "slidesToScroll": 1,
                                        "infinite": false,
                                        "arrows": true,
        ...
        <!-- Kenne's Blog List View Area End Here -->
