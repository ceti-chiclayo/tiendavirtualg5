...
<head>
    ...
    <title>Single Product Slider || Kenne</title>
...
<body class="template-color-1">
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                <div class="breadcrumb-content">
                    ...
                    <ul>
                        ...
                        <li class="active">Single Product Slider</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- Begin Kenne's Single Product Slider Area -->
        <div class="sp-area sp-slider_area">
            <div class="container">
                <div class="sp-nav">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="sp-slider kenne-element-carousel arrow-style-2 arrow-style-3" data-slick-options='{
                            "slidesToShow": 5,
                            "arrows" : true,
                            "spaceBetween": 30
        ...
        <!-- Kenne's Single Product Slider Area End Here -->
